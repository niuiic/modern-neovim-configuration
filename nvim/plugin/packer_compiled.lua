...
_G.packer_plugins = {
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/home/niuiic/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
  ...
  ["vim-translator"] = {
    loaded = true,
    path = "/home/niuiic/.local/share/nvim/site/pack/packer/start/vim-translator",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/home/niuiic/.local/share/nvim/site/pack/packer/start/vim-vsnip",
