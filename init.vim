...
autocmd FileType vim nnoremap <AC-l> gg=G
...
" zeavim.vim
nmap <silent><nowait> <space>zo <Plug>Zeavim
vmap <silent><nowait> <space>zo <Plug>ZVVisSelection
nmap <silent><nowait> <space>zs <Plug>ZVKeyDocset

let g:which_key_map1.z = {
	\ 'name' : '+zeal',
	\ 'o' : 'open in zeal',
	\ 's' : 'search in zeal',
	\ }

let g:zv_zeal_executable = has('linux64')
	\ ? $ProgramFiles . '/usr/bin/zeal'
	\ : 'zeal'
...
let g:multi_cursor_select_all_word_key = '<AC-n>'
let g:multi_cursor_start_key           = 'g<C-n>'
let g:multi_cursor_select_all_key      = 'g<AC-n>'
...
nnoremap <silent><nowait> <space>sd :<C-u>:AsyncTask file-debug<CR>
...
let g:asynctasks_term_rows = 25    " 设置纵向切割高度
...
au BufEnter * :match Todo /FIXME\|TODO\|NOTE\|KEY\|IDEA\|CHANGED\|BUG\|IDEA\|%ERROR%\|%WARNING%/
